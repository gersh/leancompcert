...
import LeanCompCert.Ports.Section413G2TableApplications

open LeanCompCert.Ports.Section413Sweep
open LeanCompCert.Ports.Section413Cells (encodeZ)
open LeanCompCert.Ports.Section413G2TableProgram (cellsOfWords)
open LeanCompCert.Ports.Section413G2TableApplications (hmLocalSegment)
...
def renderChunk (start index : Nat) (words : Array (UInt64 × UInt64)) : String :=
  ...
  String.intercalate "\n" ([
    "import LeanCompCert.Ports.Section413G2TableApplications",
    "namespace LeanCompCert.Ports.Section413G2Generated10000Chunks",
    "open LeanCompCert.Ports.Section413Sweep",
    ...
    "  decide +kernel",
    "end LeanCompCert.Ports.Section413G2Generated10000Chunks",
    ""])
...
def renderAggregate (cap chunkLen chunkCount : Nat)
  ...
  let imports := tags.map fun tag =>
    s!"import LeanCompCert.Ports.Section413G2Generated10000Chunks.Chunk{tag}"
  ...
  String.intercalate "\n" (imports ++ [
    ...
    "  exact suffix00",
    "",
    s!"theorem expected{cap}_hmV2_ok : hmV2TableOK expected{cap} {cap} = true := by",
    "  unfold hmV2TableOK",
    s!"  rw [total{cap}]",
    "  decide",
    "",
...
def main (args : List String) : IO UInt32 := do
  ...
  IO.println "namespace LeanCompCert.Ports.Section413G2Generated"
