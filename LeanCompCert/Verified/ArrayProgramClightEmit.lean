...
def emitRolledAProgramContract (fnName : String) (p : AProgram)
  ...
  String.intercalate "\n" [
    ...
    "  - apply adinstrs_wfb_sound.",
    s!"    change (adinstrs_wfb {p.regCount} ({listTerm p.init}) = true); reflexivity.",
    "  - apply adinstrs_wfb_sound.",
    s!"    change (adinstrs_wfb {p.regCount} ({listTerm p.body}) = true); reflexivity.",
    "  - apply adinstrs_wfb_sound.",
    s!"    change (adinstrs_wfb {p.regCount} ({listTerm p.epilogue}) = true); reflexivity.",
