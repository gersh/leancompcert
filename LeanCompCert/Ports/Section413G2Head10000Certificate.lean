import LeanCompCert.Ports.Section413G2Generated10000Chunks.Aggregate
...
namespace LeanCompCert.Ports.Section413G2Head10000Certificate
...
theorem headCfg_admissible :
    LeanCompCert.Ports.Section413G2Sound.Admissible headCfg :=
...
axiom section413G2Head10000_compcert_run :
  Option.bind
...
theorem expected10000_pointwise :
    ∀ X, 1 ≤ X → X ≤ 10000 →
      expected10000[X]! =
        (LeanCompCert.Ports.Section413G2Sound.g2Prefix 999 33 10000 X).g := by
  have h := compiled_zero_expected_g2 headCfg expected10000
    headCfg_tableAdmissible headCfg_admissible expected10000_canonical 0
    headCfg_baseOk section413G2Head10000_compcert_run
  simpa only [headCfg] using h.2

theorem hmV2OK_999_10000 : hmV2OK 999 10000 = true :=
  hmV2OK_of_table 999 33 10000 expected10000 expected10000_pointwise
    expected10000_hmV2_ok

end LeanCompCert.Ports.Section413G2Head10000Certificate
