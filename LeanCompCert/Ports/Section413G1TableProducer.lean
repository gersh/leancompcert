...
/-- Rolled-artifact counterpart of `producer_compiled_zero_sound`.  The
counter-driven executable contains one copy of the loop body; the source
recurrence remains symbolic in Lean. -/
